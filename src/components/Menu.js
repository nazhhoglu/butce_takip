...
const SideMenu = () => (
  <Menu
    ...
    style={{ height: "100%", borderRight: 0,width: "250px",padding: "10px",boxShadow: "0 4px 8px 0 rgba(0, 0, 0, 0.2)"}}
    className="custom-menu"
  >
    <Menu.Item key="1" icon={<DashboardOutlined />}className="custom-menu-item">
